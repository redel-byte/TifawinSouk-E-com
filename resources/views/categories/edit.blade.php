...
<body class="bg-gray-50">
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        <div class="mb-10 text-center">
            <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-3">Create New Category</h1>
            <p class="text-gray-600 max-w-2xl mx-auto">Add a new category to organize your products effectively.</p>
        </div>
        ...
        <div class="form-container bg-white rounded-xl overflow-hidden">
            ...
            <div class="header-gradient text-white p-6">
                <div class="flex flex-col md:flex-row md:items-center justify-between">
                    <div>
                        <h2 class="text-2xl font-bold">Category Information</h2>
                        <p class="text-blue-100 mt-1">Fill in the details below to create a new category</p>
                    </div>
                    <div class="mt-4 md:mt-0">
                        <span class="inline-block bg-blue-800 text-white px-4 py-2 rounded-lg font-medium">
                            <i class="fas fa-tag mr-2"></i> Category System
                        </span>
                    </div>
                </div>
            </div>
            ...
            <!-- Form -->
            <form method="POST" action="{{ route('category.store') }}" class="p-6 md:p-8">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-2">Enter a descriptive name for the category</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-2">Optional: Add a description to help categorize products better</p>
                    </div>
                </div>
