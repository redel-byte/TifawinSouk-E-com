...
<body class="bg-gray-50">
    <div class="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div class="form-container bg-white rounded-xl overflow-hidden">
            ...
            <!-- Form -->
            <form id="productForm" class="p-6 md:p-8" method="POST" action="{{ route('products.update',$product->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" id="product" value="{{ $product->name }}" name="name" required
                ...
                <div class="mb-8">
                    ...
                    <textarea id="description" name="description" rows="4" required
                        ...
                        placeholder="Provide a detailed description of the product including features, specifications, and usage...">{{ $product->description }}</textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" id="price" name="price" min="0" value="{{ $product->price }}" step="0.01" required
